...
var layout = {
  ...
  hideFrom: {
    ...
    transform: (value, theme2) => {
      var _a7, _b5, _c4;
      const breakpoint = (_c4 = (_b5 = (_a7 = theme2.__breakpoints) == null ? void 0 : _a7.get(value)) == null ? void 0 : _b5.minW) != null ? _c4 : value;
  ...
  hideBelow: {
    ...
    transform: (value, theme2) => {
      var _a7, _b5, _c4;
      const breakpoint = (_c4 = (_b5 = (_a7 = theme2.__breakpoints) == null ? void 0 : _a7.get(value)) == null ? void 0 : _b5._minW) != null ? _c4 : value;
...
function getCss(options) {
  ...
  const css22 = (stylesOrFn, nested = false) => {
    ...
    for (let key in styles2) {
      ...
      let rawValue = (_c4 = (_b5 = config2 == null ? void 0 : config2.transform) == null ? void 0 : _b5.call(config2, value, theme2, _styles)) != null ? _c4 : value;
...
var baseStyle12 = definePartsStyle9((props) => {
  ...
  return {
    ...
    container: (_d3 = (_c4 = checkboxTheme).baseStyle) == null ? void 0 : _d3.call(_c4, props).container,
...
function getSize2(size2) {
  ...
  const _fontSize = (_c4 = (_b5 = sizeStyle.field) == null ? void 0 : _b5.fontSize) != null ? _c4 : "md";
...
var variants7 = {
  outline: defineStyle(
    (props) => {
      var _a32, _b22, _c4;
      return (_c4 = (_b22 = runIfFn2((_a32 = inputTheme.variants) == null ? void 0 : _a32.outline, props)) == null ? void 0 : _b22.field) != null ? _c4 : {};
    }
  ),
  flushed: defineStyle(
    (props) => {
      var _a32, _b22, _c4;
      return (_c4 = (_b22 = runIfFn2((_a32 = inputTheme.variants) == null ? void 0 : _a32.flushed, props)) == null ? void 0 : _b22.field) != null ? _c4 : {};
    }
  ),
  filled: defineStyle(
    (props) => {
      var _a32, _b22, _c4;
      return (_c4 = (_b22 = runIfFn2((_a32 = inputTheme.variants) == null ? void 0 : _a32.filled, props)) == null ? void 0 : _b22.field) != null ? _c4 : {};
    }
  ),
...
function buildTransform(_a7, _b5, transformIsDefault, transformTemplate2) {
  ...
  var _c4 = _b5.enableHardwareAcceleration, enableHardwareAcceleration = _c4 === void 0 ? true : _c4, _d3 = _b5.allowTransformNone, allowTransformNone = _d3 === void 0 ? true : _d3;
  var transformString = "";
...
function buildTransformOrigin(_a7) {
  var _b5 = _a7.originX, originX = _b5 === void 0 ? "50%" : _b5, _c4 = _a7.originY, originY = _c4 === void 0 ? "50%" : _c4, _d3 = _a7.originZ, originZ = _d3 === void 0 ? 0 : _d3;
...
function test(v) {
  var _a7, _b5, _c4, _d3;
  return isNaN(v) && isString(v) && ((_b5 = (_a7 = v.match(floatRegex)) === null || _a7 === void 0 ? void 0 : _a7.length) !== null && _b5 !== void 0 ? _b5 : 0) + ((_d3 = (_c4 = v.match(colorRegex)) === null || _c4 === void 0 ? void 0 : _c4.length) !== null && _d3 !== void 0 ? _d3 : 0) > 0;
}
function analyse(v) {
  if (typeof v === "number")
    v = `${v}`;
...
function buildSVGAttrs(state2, _a7, options, transformTemplate2) {
  var attrX = _a7.attrX, attrY = _a7.attrY, originX = _a7.originX, originY = _a7.originY, pathLength = _a7.pathLength, _b5 = _a7.pathSpacing, pathSpacing = _b5 === void 0 ? 1 : _b5, _c4 = _a7.pathOffset, pathOffset = _c4 === void 0 ? 0 : _c4, latest = __rest(_a7, ["attrX", "attrY", "originX", "originY", "pathLength", "pathSpacing", "pathOffset"]);
...
function animate(_a7) {
  ...
  if ((_c4 = (_b5 = animator).needsInterpolation) === null || _c4 === void 0 ? void 0 : _c4.call(_b5, from, to)) {
...
function checkTargetForNewValues(visualElement2, target, origin) {
  ...
  for (var i = 0; i < numNewValues; i++) {
    ...
    visualElement2.addValue(key, motionValue(value));
    (_c4 = (_d3 = origin)[key]) !== null && _c4 !== void 0 ? _c4 : _d3[key] = value;
...
function animateVariant(visualElement2, variant, options) {
  ...
  if (when) {
    var _c4 = __read(when === "beforeChildren" ? [getAnimation2, getChildAnimations] : [getChildAnimations, getAnimation2], 2), first = _c4[0], last = _c4[1];
...
function animateTarget(visualElement2, definition, _a7) {
  var _b5;
  var _c4 = _a7 === void 0 ? {} : _a7, _d3 = _c4.delay, delay = _d3 === void 0 ? 0 : _d3, transitionOverride = _c4.transitionOverride, type = _c4.type;
...
var VisualElementDragControls = (
  ...
  function() {
    ...
    VisualElementDragControls2.prototype.start = function(originEvent, _a7) {
      var _this = this;
      var _b5 = _a7 === void 0 ? {} : _a7, _c4 = _b5.snapToCursor, snapToCursor = _c4 === void 0 ? false : _c4;
    ...
    VisualElementDragControls2.prototype.getProps = function() {
      ...
      var _a7 = props.drag, drag2 = _a7 === void 0 ? false : _a7, _b5 = props.dragDirectionLock, dragDirectionLock = _b5 === void 0 ? false : _b5, _c4 = props.dragPropagation, dragPropagation = _c4 === void 0 ? false : _c4, _d3 = props.dragConstraints, dragConstraints = _d3 === void 0 ? false : _d3, _e3 = props.dragElastic, dragElastic = _e3 === void 0 ? defaultElastic : _e3, _f3 = props.dragMomentum, dragMomentum = _f3 === void 0 ? true : _f3;
...
var positionalValues = {
  ...
  width: function(_a7, _b5) {
    var x = _a7.x;
    var _c4 = _b5.paddingLeft, paddingLeft = _c4 === void 0 ? "0" : _c4, _d3 = _b5.paddingRight, paddingRight = _d3 === void 0 ? "0" : _d3;
    return x.max - x.min - parseFloat(paddingLeft) - parseFloat(paddingRight);
  },
  height: function(_a7, _b5) {
    var y = _a7.y;
    var _c4 = _b5.paddingTop, paddingTop = _c4 === void 0 ? "0" : _c4, _d3 = _b5.paddingBottom, paddingBottom = _d3 === void 0 ? "0" : _d3;
...
function mixValues(target, follow, lead, progress2, shouldCrossfadeOpacity, isOnlyMember) {
  ...
  if (shouldCrossfadeOpacity) {
    ...
    target.opacity = mix2((_c4 = follow.opacity) !== null && _c4 !== void 0 ? _c4 : 1, (_d3 = lead.opacity) !== null && _d3 !== void 0 ? _d3 : 1, progress2);
  }
  ...
  function() {
    ...
    NodeStack2.prototype.exitAnimationComplete = function() {
      this.members.forEach(function(node) {
        var _a7, _b5, _c4, _d3, _e3;
        (_b5 = (_a7 = node.options).onExitComplete) === null || _b5 === void 0 ? void 0 : _b5.call(_a7);
        (_e3 = (_c4 = node.resumingFrom) === null || _c4 === void 0 ? void 0 : (_d3 = _c4.options).onExitComplete) === null || _e3 === void 0 ? void 0 : _e3.call(_d3);
      });
    };
    ...
    function() {
      ...
      ProjectionNode.prototype.mount = function(instance, isLayoutDirty) {
        ...
        if (this.options.animate !== false && visualElement2 && (layoutId || layout2)) {
          this.addEventListener("didUpdate", function(_a9) {
            ...
            var layoutTransition = (_c4 = (_b6 = _this.options.transition) !== null && _b6 !== void 0 ? _b6 : visualElement2.getDefaultTransition()) !== null && _c4 !== void 0 ? _c4 : defaultLayoutTransition;
      ...
      ProjectionNode.prototype.willUpdate = function(shouldNotifyListeners) {
        ...
        if (layoutId === void 0 && !layout2)
          return;
        var transformTemplate2 = (_c4 = this.options.visualElement) === null || _c4 === void 0 ? void 0 : _c4.getProps().transformTemplate;
      ...
      ProjectionNode.prototype.registerSharedNode = function(layoutId, node) {
        ...
        node.promote({
          ...
          preserveFollowOpacity: (_c4 = (_b5 = node.options.initialPromotionConfig) === null || _b5 === void 0 ? void 0 : _b5.shouldPreserveFollowOpacity) === null || _c4 === void 0 ? void 0 : _c4.call(_b5, node)
        });
      };
      ...
      ProjectionNode.prototype.getProjectionStyles = function(styleProp) {
        ...
        if (lead.animationValues) {
          styles2.opacity = lead === this ? (_d3 = (_c4 = valuesToRender.opacity) !== null && _c4 !== void 0 ? _c4 : this.latestValues.opacity) !== null && _d3 !== void 0 ? _d3 : 1 : this.preserveOpacity ? this.latestValues.opacity : valuesToRender.opacityExit;
        } else {
...
function notifyLayoutUpdate(node) {
  ...
  if (node.isLead() && node.layout && snapshot && node.hasListeners("didUpdate")) {
    ...
    (_d3 = (_c4 = node.options).onExitComplete) === null || _d3 === void 0 ? void 0 : _d3.call(_c4);
  }
    ...
    function() {
      return {
        ...
        onExitComplete: function(childId) {
          ...
          try {
            for (var _b5 = __values(presenceChildren.values()), _c4 = _b5.next(); !_c4.done; _c4 = _b5.next()) {
              var isComplete = _c4.value;
              if (!isComplete)
                return;
            }
          } catch (e_1_1) {
            ...
            try {
              if (_c4 && !_c4.done && (_a8 = _b5.return))
                _a8.call(_b5);
            } finally {
              if (e_1)
                throw e_1.error;
...
var AnimatePresence = function(_a7) {
  var children = _a7.children, custom = _a7.custom, _b5 = _a7.initial, initial = _b5 === void 0 ? true : _b5, onExitComplete = _a7.onExitComplete, exitBeforeEnter = _a7.exitBeforeEnter, _c4 = _a7.presenceAffectsLayout, presenceAffectsLayout = _c4 === void 0 ? true : _c4;
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1704750727998.4326";
}
var meta = () => {
  return [{
    charset: "utf-8"
...
var Document = _s(withEmotionCache(_c3 = _s(({
  ...
  _s();
  const serverStyleData = (0, import_react57.useContext)(ServerStyleContext);
  const clientStyleData = (0, import_react57.useContext)(ClientStyleContext);
...
_c22 = Document;
function App() {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Document, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(ChakraProvider2, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Outlet, {}, void 0, false, {
    fileName: "app/root.tsx",
    lineNumber: 94,
    columnNumber: 9
  }, this) }, void 0, false, {
...
//# sourceMappingURL=/build/root-AFGZQBJX.js.map
